...
CORS_ORIGINS = [
    origin.strip()
    for origin in ('http://localhost:3000,https://meet.google.com,https://drive.google.com,https://mail.google.com,https://gmail.com,http://0.0.0.0:5000,https://unstop.com').split(',')
    if origin.strip()
]
